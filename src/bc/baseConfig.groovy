...
class baseConfig {
  ...
  public static final String  NAME_SPACE = 'admgjk'
  ...
  public static final String[] APPS = ['vc-authn-database', 'vc-authn-agent', 'vc-authn-controller', 'issuer-agent', 'issuer-api', 'issuer-db', 'issuer-wallet', 'issuer-web', 'issuer-admin']
}